...
const initPlanet = (): {
	...
	const dayTexture = TL.load("./assets/earth/day.jpg");
	const nightTexture = TL.load("./assets/earth/night.jpg");
	const specularCloudsTexture = TL.load("./assets/earth/specularClouds.jpg");
